...
class ChangeViewModel extends ViewModel{
    public $viewFields = array(
        'Change' => array('id'=>'chid','applytime','guide','profession','cname'=>'forcname','phone'=>'cphone','position'=>'forposition','address','insurance','reason','status','type','_as'=>'myChange','_type'=>'LEFT'),
        ...
        'Practice' => array('position','cname','starttime','endtime','_on'=>'Practice.student_id = Student.studentno','_type'=>'LEFT'),
