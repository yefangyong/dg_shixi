...
<main>
    <div class="ui-head">
        <div class="container">
            ...
            <div class="tabs">
                <ul>
                    <li><a href="/teacher.php/Notice/index" class="on">公告</a></li>
                    <li><a href="">系统消息</a></li>
                    <li><a href="">预警信息</a></li>
                </ul>
            </div>
    ...
    <div class="ui-path">
        <p><span class="pull-right"><a href="/teacher.php/Notice/index" style="font-size: 15px">返回</a></span>
            <a href="" class="home"></a>
            <a href="/teacher.php/Notice/index" style="font-size: 15px">消息管理</a>
            &gt;
            <a href="/teacher.php/Notice/index" style="font-size: 15px" class="on">公告查看</a>
        </p>
    </div>
    <div class="ui-main">
        <div class="container">
            ...
            <div class="ui-article">
                <div class="hd">
                    ...
                    <p>
                        发布人：<?php echo ($list["teacher_name"]); ?>
                        <span class="wh30"></span>
                        发布对象:<?php echo ($list["publisher"]); ?>  <?php if($list["type"] == 1): ?>学生<elseif condition="$list.type eq 2">教师<?php endif; ?>
                        <span class="wh30"></span>
