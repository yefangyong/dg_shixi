        ...
        <div class="container">
            ...
            <div class="ui-table">
                <div class="hd">
                    ...
                    <div class="tool">
                        <p>
                            <a href="<?php echo U('Apply/export');?>">导出</a>
                            &nbsp;
                ...
                <div class="ct">
                    <table>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                <td><a href="" class="cbox" attr-id="<?php echo ($v["studentno"]); ?>"></a></td>
                                ...
                                <td>
                                    <a href="/teacher.php/Apply/editApply/id/<?php echo ($v["pid"]); ?>"><?php if($v['status'] == 0): ?>审核<?php else: ?>查看<?php endif; ?></a>
                                    <a href="javascript:void(0)" class="del" attr-id="<?php echo ($v["studentno"]); ?>">删除</a>
                                </td>
        ...
        $('#deleteall').click(function(){
            ...
            if(ids.length>0)
                layer.confirm('您真的要删除选中记录吗?', {icon: 3, title:'删除记录'}, function(index){
                    var $url = "<?php echo U('Apply/delApply');?>";
