        ...
        <div class="container">
            ...
            <div class="ui-table">
                <div class="hd">
                    ...
                    <div class="tool">
                        <p>
                            <a href="<?php echo U('Apply/exportLeave');?>">导出</a>
                            &nbsp;
                ...
                <div class="ct">
                    <table>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="/teacher.php/Apply/editLeave/id/<?php echo ($v["id"]); ?>"><?php if($v['status'] == 0): ?>审核<?php else: ?>查看<?php endif; ?></a>
...
<script>
    $(function(){
        $('.bt').click(function(){
            ...
            window.location.href="/teacher.php/Apply/leave/department/"+_department+"/profession/"+_profession+"/class/"+_class+"/corporation/"+_corporation+"/status/"+_status+"/keywords/"+$('#keywords').val();
        })
