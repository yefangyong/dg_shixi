        ...
        <div class="container">
            ...
            <div class="ui-article">
                ...
                <div class="ft">
                    ...
                    <p>
                        <label for="">时间：<b><?php echo ($apply["starttime"]); ?>~<?php echo ($apply["endtime"]); ?></b></label>
                    </p>
                </div>
            </div>
            <div class="ht90"></div>
            ...
            <div class="ui-state">
                <p class="text-center" style="font-size: 20px;">
                    <b>当前状态：</b>已审核/<?php echo (isAgree($apply["status"])); ?>
                </p>
            </div>
        </div>
    </div>
