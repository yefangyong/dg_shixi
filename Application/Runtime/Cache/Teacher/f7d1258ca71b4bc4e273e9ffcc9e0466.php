            ...
            <div class="ui-form style2">
                <form class="form-horizontal" method="post" id="studentForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="classname" style="width: 210px;" value="<?php echo ($info["classname"]); ?>" placeholder="请输入系名" id="classname" onblur="isEmpty(this.id)">
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-4">
                            <div class="select" style="width: 210px;">
                                <p id="gra"><a href="javascript:void(0);"><?php echo ($info["grade"]); ?></a></p>
                                <div class="ex">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="select" style="width: 210px;">
                                <p id="teacher"><a href="javascript:void(0);"><?php echo ($info["teacher"]); ?></a></p>
                                <div class="ex">
                        ...
                        <div class="col-sm-4">
                            <div class="select" style="width: 210px;">
                                <p id="dept"><a href="javascript:void(0);"><?php echo ($info["dname"]); ?></a></p>
                                <div class="ex">
                    ...
                    <input type="hidden" name="master_no" id="master_no" value="<?php echo ($info["master_no"]); ?>" />
                    <input type="hidden" name="dep_id" id="dep_id" value="<?php echo ($info["dep_id"]); ?>" />
                    <input type="hidden" name="grade" id="grade" value="<?php echo ($info["grade"]); ?>">
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(function(){
        ...
        $('button[type=button]').click(function(){
            ...
            var $url = "<?php echo U('Student/updateclass');?>";
