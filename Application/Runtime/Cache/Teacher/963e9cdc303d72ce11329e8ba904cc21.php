        ...
        <div class="ex">
            ...
            <div class="tabs">
                <ul>
                    ...
                    <li><a href="<?php echo U('Student/teacher');?>" class="on">教师管理</a></li>
                    <li><a href="<?php echo U('Student/classes');?>" >班级管理</a></li>
                    <li><a href="<?php echo U('Student/department');?>" >部门管理</a></li>
                </ul>
        </div>
    </div>
    <div class="ht15"></div>
        ...
        <div class="container">
            ...
            <div class="ui-table">
                <div class="hd">
                    ...
                    <div class="tool">
                        <p>
                            <a href="<?php echo U('Student/importTea');?>">导入</a>
                            &nbsp;
                            <a href="<?php echo U('Student/exportTea');?>">导出</a>
                            &nbsp;
                ...
                <div class="ct">
                    <table>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo ($v["teacherno"]); ?></td>
                                <td><?php echo ($v["name"]); ?></td>
                                <td><?php echo (setTeacherType($v["type"])); ?></td>
...
<script>
    $(function(){
        $('.bt').click(function(){
            ...
            window.location.href="/teacher.php/Student/teacher/department/"+_department+"/profession/"+_profession+"/class/"+_class+"/keywords/"+$('#keywords').val();
        ...
        $('#deleteall').click(function(){
            ...
            if(ids.length>0)
                layer.confirm('您真的要删除选中记录吗?', {icon: 3, title:'删除记录'}, function(index){
                    var $url = "<?php echo U('Student/delteacher');?>";
                    $.post($url,{id:ids},function(msg){
                        if(msg.status==1){
                            layer.msg(msg.message,{icon:6},function(){
                                window.location.href="/teacher.php/Student/teacher";
                            });
                        }else{
