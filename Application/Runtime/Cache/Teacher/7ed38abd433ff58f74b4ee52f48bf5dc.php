            ...
            <div class="tabs">
                <div class="ct">
                    <ul>
                        ...
                        <li><a href="<?php echo U('Apply/position');?>" class="on">实习岗位变更</a></li>
        ...
        <div class="container">
            ...
            <div class="ui-article">
                <div class="hd">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="center">保险：<?php echo (isPayInsurance($apply["insurance"])); ?></td>
                ...
                <div class="ct">
                    ...
                    <div style="font-size: 15px"><?php echo ($apply["reason"]); ?></div>
                </div>
            </div>
            <div class="ht90"></div>
            <p class="text-center">
