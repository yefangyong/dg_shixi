            ...
            <div class="ui-form style2">
                <form class="form-horizontal" method="post" id="corporationForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  name="name" style="width: 210px;" placeholder="请输入企业名称" id="name" onblur="isEmpty(this.id)">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="contact" style="width: 210px;" placeholder="请输入企业联系人" id="contact" onblur="isEmpty(this.id)">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="department" style="width: 210px;" placeholder="请输入工作部门">
                        </div>
                        <div class="col-sm-2">
                            <label for="" class="control-label">职务</label>
                        </div>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="position" style="width: 210px;" placeholder="请输入工作职务">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="telephone" style="width: 210px;" placeholder="请输入联系电话" id="telephone" onblur="isEmpty(this.id)">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="email" style="width: 210px;" placeholder="请输入企业邮箱">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="fax" style="width: 210px;" placeholder="请输入传真号码">
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-4">
                            <div class="select" style="width: 210px;">
                                <input type="text" class="form-control" name="address" style="width: 210px; color: #78a9e6;" placeholder="请输入企业详细地址" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="website" style="width: 210px;" placeholder="请输入企业网址">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <div class="textarea" style="width: 93%;"><label for="">0/2000</label>
                                <textarea class="form-control" placeholder="请输入企业详细介绍" name="introduction"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="ht15"></div>
