        ...
        <div class="container">
            ...
            <div class="ui-table">
                <div class="hd">
                    <div class="tool">
                        <p>
                            <a href="<?php echo U('Corporation/add');?>">新增</a>
                            &nbsp;
                            <a href="">删除</a>
                            &nbsp;
                            <a href="">设置为使用</a>
                ...
                <div class="ct">
                    <table>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo (CorporationStatus($v["isused"])); ?></td>
                                <td>
                                    <a href="javascript:void(0);" id="yfycms-edit" attr-id="<?php echo ($v["id"]); ?>">编辑</a>
                                    <a href="javascript:void(0);" id="yfycms-delete" attr-id="<?php echo ($v["id"]); ?>" attr-message="删除">删除</a>
                                </td>
