        ...
        <div class="container">
            ...
            <div class="ui-filter">
                ...
                <div class="select">
                    ...
                    <div class="ex">
                        <div class="list">
                            <p><a name="status" attr-id="2" href="">已审核</a></p>
                ...
                <div class="ct">
                    <table>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="edit" attr-id="<?php echo ($v["rid"]); ?>" attr-status="<?php echo ($v["status"]); ?>"><?php if($v['status'] == 0): ?>审核<?php else: ?>查看<?php endif; ?></a>
