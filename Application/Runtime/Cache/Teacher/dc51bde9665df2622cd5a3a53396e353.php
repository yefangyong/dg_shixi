        ...
        <div class="container">
            ...
            <div class="ui-table">
                <div class="hd">
                    ...
                    <div class="tool">
                        <p>
                            <a href="<?php echo U('Student/adddep');?>">新增</a>
                            &nbsp;
                ...
                <div class="ct">
                    <table>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <a href="/teacher.php/Student/class/id/<?php echo ($v["sid"]); ?>">查看</a>
                                    <a href="/teacher.php/Student/updatedep/id/<?php echo ($v["id"]); ?>">编辑</a>
        ...
        $('#deleteall').click(function(){
            ...
            if(ids.length>0)
                layer.confirm('您真的要删除选中记录吗?', {icon: 3, title:'删除记录'}, function(index){
                    var $url = "<?php echo U('Student/deldep');?>";
