...
<main>
    ...
    <div class="user">
        ...
        <div class="ex">
            ...
            <div class="tabs">
                <div class="ct">
                    <ul>
                        <li><a href="<?php echo U('Practice/corporation');?>" class="on">企业管理</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="ui-path">
        <p>
            ...
            <a href="<?php echo U('Practice/corporation');?>">企业管理</a>
            >
    ...
    <div class="ui-main">
        <div class="container">
          ...
          <div class="ui-form style3">
            <form class="form-horizontal" id="upform" enctype="multipart/form-data" action="<?php echo U('Practice/importCor');?>" method="post" target="hideframe">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <a href="<?php echo U('Practice/exportCortemp');?>" class="font1">导入模板下载</a>
                </div>
              </div>
            </form>
          </div>
