        ...
        <div class="container">
            ...
            <div class="ui-table">
                <div class="hd">
                    <div class="tool">
                        <p>
                            <a href="/index.php?m=student&c=apply&a=addLeave">新增</a>
                        </p>
                    </div>
                </div>
                <div class="ct">
                    <table class="yfycms-table">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" attr-id="<?php echo ($vo["id"]); ?>" id="yfycms-view">查看</a> <a href="javascript:void(0);" id="yfycms-delete" attr-message="删除" attr-id="<?php echo ($vo["id"]); ?>">删除</a>
                                </td>
...
<script>
        ...
        var SCOPE = {
            ...
            'set_status_url':'/index.php?m=student&c=apply&a=delLeave',
            'view_url':'/index.php?m=student&c=apply&a=viewLeave'
        };
