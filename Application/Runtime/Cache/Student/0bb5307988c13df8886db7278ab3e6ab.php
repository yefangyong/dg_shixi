    ...
    <div class="ui-main">
        <div class="container">
            ...
            <div class="ui-article">
                <div class="hd">
                    <h3><?php echo getLoginUsername() ?>的岗位变更申请</h3>
                </div>
                <div class="ht20"></div>
                <div class="ui-head1">
                    <p>个人信息</p>
                ...
                <div class="hd">
                    <table>
                        <tr>
                            <td>实习企业：<?php echo ($corporation['name']); ?></td>
                            <td>原岗位：<?php echo ($practice['position']); ?></td>
                            <td>现岗位：<?php echo ($change['position']); ?></td>
                        </tr>
                        <tr>
                            <td>所在地址：<?php echo ($corporation['address']); ?></td>
