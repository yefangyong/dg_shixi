            ...
            <div class="ui-form style2">
                <form class="form-horizontal" id="yfycms-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="title" value="<?php echo ($data["title"]); ?>" class="form-control" id="" style="width: 210px;" placeholder="请输入实习报告标题">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <div class="textarea"><label for="">0/2000</label>
                                <textarea class="form-control" name="content" placeholder="请输入实习报告标题"><?php echo ($data["content"]); ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                ...
                                <img style="display: none" id="upload_org_code_img" src="<?php echo ($data["pic"]); ?>" width="150" height="150">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="select" style="width: 210px;">
                                <input type="text" name="address" value="<?php echo ($data["address"]); ?>" class="form-control" id="" style="width: 210px;" placeholder="请输入实习地址">
                            </div>
                        </div>
                    </div>
                    <div class="ht15"></div>
