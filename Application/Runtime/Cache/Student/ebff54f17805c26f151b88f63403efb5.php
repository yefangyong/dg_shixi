...
<main>
    <div class="ui-head">
        <div class="container">
            ...
            <div class="tabs">
                <div class="ct">
                    <ul>
                        <li><a href="/index.php/student/apply/index" class="on">实习申请</a></li>
    ...
    <div class="ui-path">
        <p><span class="pull-right"><a href="/index.php/student/apply/index" style="font-size: 15px">返回</a></span>
            ...
            &gt;
            <a href="" class="on" style="font-size: 15px">实习申请状态</a>
        </p>
    </div>
    <div class="ui-main">
        <div class="container">
            ...
            <div class="ui-article">
                <div class="hd">
                    <h3><?php echo getLoginUsername();?>的实习申请</h3>
                </div>
            </div>
            <div class="ht25"></div>
            <div class="ui-head1">
            ...
            <div class="ui-article">
                <div class="hd">
                    <table>
                        <tr>
                            <td align="left">企业名称：<?php echo ($practice['cname']); ?></td>
                            <td align="">企业地址：<?php echo ($practice['address']); ?></td>
                            <td align="">专业对口：<?php echo (getProfessionStatus($practice['profession'])); ?></td>
                            <td align="">保险购买：<?php echo (getInsuranceStatus($practice['insurance'])); ?></td>
                        </tr>
                        <tr>
                            <td align="left">职务：<?php echo ($practice['position']); ?></td>
                            <td align="">企业指导老师：<?php echo ($practice['guide']); ?></td>
                            <td align="">联系电话：<?php echo ($practice['phone']); ?></td>
                        </tr>
                        <tr>
                            <td align="left">详细地址：<?php echo ($practice['detailaddress']); ?></td>
                            <td align="">开始日期：<?php echo (substr($practice['starttime'],0,10)); ?></td>
                            <td align="" colspan="2">结束日期：<?php echo (substr($practice['endtime'],0,10)); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
