            ...
            <div class="ui-form style2">
                <form class="form-horizontal" id="yfycms-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="course" class="select" style="width: 210px;">
                                <option value="">请选择您的实习课程</option>
                    ...
                    <div class="form-group">
                        <div class="col-sm-2">
                            <label for="" class="control-label">下周计划</label>
                        </div>
                        <div class="col-sm-10">
                            <div class="textarea"><label for="">0/2000</label>
                                <textarea class="form-control" name="nexplan" placeholder="请输入下周计划"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
